...
class EnvelopeTools:
    ...
    @register
    async def get_envelope(self, envelope_id: Annotated[int, "ID of the envelope to retrieve"]) -> list[TextContent]:
    ...
    @register
    async def delete_envelope(self, envelope_id: Annotated[int, "ID of the envelope to delete"]) -> list[TextContent]:
