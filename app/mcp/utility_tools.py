...
class UtilityTools:
    ...
    async def get_envelope_balance(
        self, envelope_id: Annotated[int, "ID of the envelope to get balance for"]
    ) -> list[TextContent]:
        ...
        try:
            ...
            logger.exception("An internal error occurred in get_envelope_balance")
            return [
                TextContent(
                    type="text",
    ...
    async def get_budget_summary(self) -> list[TextContent]:
        ...
        try:
            ...
            total_spent = (
                total_starting_balance - total_current_balance
            ...
            logger.exception("An internal error occurred in get_budget_summary")
            return [
                TextContent(
                    type="text",
